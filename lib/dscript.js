...
(function() {
  ...
  Fail = (function() {
    ...
    Fail.prototype.map = function(f) {
      throw this.what;
    };

    Fail.prototype.flatMap = function(f) {
      throw this.what;
    };
    ...
    Fail.prototype.getOrElse = function(f) {
      throw this.what;
    };

    Fail.prototype.orElse = function(f) {
      throw this.what;
    };

    Fail.prototype.isEmpty = function() {
      throw this.what;
    };
      ...
      return this.socket.map((function(s) {
        ...
        sendData = function(x) {
          ...
          try {
            ...
            e = _error;
            return console.log("Exception while sending data " + e);
          }
        };
  ...
  */
  ...
  Runtime = (function() {
    ...
    Runtime.prototype.closeDataReaderConnection = function(dr) {
      var sock, _ref;
      _ref = this.drconnections[dr.eid], dr = _ref.dr, sock = _ref.sock;
      if (sock !== void 0) {
        sock.close();
        return delete this.drconnections[dr.eid];
      }
    };

    Runtime.prototype.closeDataWriterConnection = function(dw) {
      var sock, _ref;
      _ref = this.dwconnections[dw.eid], dw = _ref.dw, sock = _ref.sock;
      if (sock !== void 0) {
        sock.close();
        return delete this.dwconnections[dw.eid];
      }
    };
    ...
    Runtime.prototype.openDataWriterConnection = function(topic, qos, dw) {
      ...
      this.sn = this.sn + 1;
      scmd = JSON.stringify(cmd);
      console.log("Creating Data Writer on " + this.ctrlSock);
      this.ctrlSock.map(function(s) {
        return s.send(scmd);
      });
    ...
    Runtime.prototype.handleMessage = function(s) {
      ...
      if (msg.h.cid === DSCommandId.OK) {
        if (msg.h.ek === DSEntityKind.DataReader) {
          ...
          drsock.onclose = function(evt) {
            dr.connected = false;
            return dr.ondisconnect(evt);
          };
